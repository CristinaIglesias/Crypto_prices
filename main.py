...
import numpy as np
import pandas as pd
import pandas_datareader as web  # Up-to-date remote data access for pandas
...
# Prepare Data - Data Normalization
...
plt.plot(actual_prices, color="pink", label="Actual Prices")
